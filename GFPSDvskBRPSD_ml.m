%%MovieLens-100k,对比GFPSD和RKHS+kBR和RKHS+PSD（copy code of predictKB.m,predictmyKBPSD.m），result from workstation
clear all;
close all;
...
if implement
    ...
    mae_us=zeros(15,1);   %前5个是RKHS+kBR的结果，中间5个是GFPSD准确结果，最后5个是GFPSD+appro结果
    rmse_us=zeros(15,1);
    mae_it=zeros(15,1);
    rmse_it=zeros(15,1);
    mtu=zeros(15,1);
...
disp(['GR+PSD   ',num2str(mean(GFPSDvskBRPSDml(6:10,1))),'+-',num2str(std(GFPSDvskBRPSDml(6:10,1))),...
    '     ',num2str(mean(GFPSDvskBRPSDml(6:10,2))),'+-',num2str(std(GFPSDvskBRPSDml(6:10,2))), '     ',num2str(mean(GFPSDvskBRPSDml(6:10,3)))]);
disp(['GFPSD+appro   ',num2str(mean(GFPSDvskBRPSDml(11:15,1))),'+-',num2str(std(GFPSDvskBRPSDml(11:15,1))),...
...
disp(['GR+PSD   ',num2str(mean(GFPSDvskBRPSDml(6:10,4))),'+-',num2str(std(GFPSDvskBRPSDml(6:10,4))),...
    '     ',num2str(mean(GFPSDvskBRPSDml(6:10,5))),'+-',num2str(std(GFPSDvskBRPSDml(6:10,5))), '     ',num2str(mean(GFPSDvskBRPSDml(6:10,6)))]);
disp(['GFPSD+appro   ',num2str(mean(GFPSDvskBRPSDml(11:15,4))),'+-',num2str(std(GFPSDvskBRPSDml(11:15,4))),...
